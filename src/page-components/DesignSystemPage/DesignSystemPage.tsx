        ...
        <div className="w-full md:w-9/12 md:pr-48">
          ...
          <h1 className="font-normal text-[2.0rem] leading-relaxed">
            ...
            <ul className="text-[1.0rem] leading-normal">
              <li className="list-disc list-inside mt-6">For each increment above our base: &ldquo;step-a#&rdquo;</li>
              <li className="list-disc list-inside mt-6">For each decrement below our base: &ldquo;step-z#&rdquo;</li>
            </ul>
            ...
            <p className="text-[1.0rem] leading-normal mt-8">
              This produced a scale where:
            </p>

            <ul className="text-[1.0rem] leading-normal">
              <li className="list-disc list-inside mt-6">The lightest shade of gray acts as a soft white</li>
              <li className="list-disc list-inside mt-6">The darkest shade of gray acts as a soft black</li>
              <li className="list-disc list-inside mt-6">Text in grays below middle gray (&le; 400) works beautifully on soft black (#222222) backgrounds</li>
              <li className="list-disc list-inside mt-6">500 is middle gray (#757575)</li>
              <li className="list-disc list-inside mt-6">Text in grays darker than middle gray (&ge; 500) works on white (#FFFFFF) backgrounds</li>
              <li className="list-disc list-inside mt-6">Gray-25 on soft black (#222222) appears as bright white</li>
              <li className="list-disc list-inside mt-6">Gray-50 on soft black (#222222) appears as white</li>
            </ul>            
            ...
            <ul className="text-[1.0rem] leading-normal mt-8" style={{ paddingLeft: '2rem' }}>
