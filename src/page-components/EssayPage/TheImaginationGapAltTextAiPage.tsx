        ...
        <div className="flex flex-wrap">
          ...
          <div className="w-full md:w-9/12 md:pr-48">
            ...
            <p className="font-normal text-base leading-normal mt-16">
              Alt-text is one of the simplest accessibility practices to
              describe, and one of the hardest to do well. It asks us to
              translate an image into language so that someone who cannot see
              the image can still understand it. But between what we intend and
              what someone else understands lies a space where the meaning
              can&nbsp;drift.
            </p>
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              automate alt-text or replace human expertise; it is to reveal the
              limits of our language so we can write with greater clarity
              and&nbsp;intention.
            </p>
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              <strong>
                {" "}
                alt-text is a written description of an image that can be read
                aloud by assistive technologies
              </strong>{" "}
              such as screen readers. It ensures that people who cannot see the
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              minds.
              <br />
              We already know what the notebook looks like, what the person in
              the photograph is doing, what the brand colors mean, what the
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              . It is especially critical in accessibility, where clarity is not
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              A reviewer may imagine something different than what the author
              intended but describe it in a way that masks the misunderstanding.
              Or they may not know which visual details the author
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              <br />
              If you give it only your alt-text, without the original image, and
              ask it to generate <em>exactly</em> what the text describes, the
              output reveals how your words function when stripped
              of&nbsp;context.
            </p>
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              <br />
              It mirrors the purpose of alt-text: factual,
            ...
            <h2
              ...
              className="font-normal text-xl leading-8 mt-12"
            >
              A Demonstration: Closing the Imagination Gap
              Through&nbsp;Iteration
            </h2>
            ...
            <figure className="mt-6">
              ...
              <figcaption className="font-normal leading-normal mt-3 text-sm text-gray-600">
                ...
                <br />
                <em>
                  &ldquo;A handmade red leather notebook cover lies closed on a
                  light wood surface. The cover is dyed in varied deep red and
                  brown tones and features a distinctive asymmetrical front flap
                  that folds over from the right side. A black fountain pen with
                  silver accents rests diagonally across the notebook from upper
                  left to lower right. The leather shows visible texture and
                  natural tonal variation, with subtle highlights from the
                  overhead lighting.&rdquo;
                </em>
                <br />
                <br />
                This is the authoritative description used for comparison in the
                alt-text reconstruction examples&nbsp;below.
              </figcaption>
            </figure>
            ...
            <ul className="font-normal text-base leading-normal mt-6 list-disc space-y-4">
              ...
              <li className="mb-1 ml-[21px]">
                proportions that don&rsquo;t quite match
              </li>
              <li className="mb-1 ml-[21px]">
            ...
            <blockquote className="font-normal text-base leading-normal mt-6 italic border-l-4 border-gray-300 pl-4 ml-6">
              ...
              fountain pen with silver accents rests diagonally across the
            ...
            <p className="font-normal text-base leading-normal mt-6">
              ...
              should&nbsp;be.
              <br />
              Language cannot encode the exact experience of hand-dyed leather
