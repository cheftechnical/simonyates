...
const StyledMyGridContainerLifeAsAMaker = styled(MyGridContainer)(
  ({ theme }) => ({
    // For mobile
    [theme.breakpoints.down("xs")]: {
      paddingBottom: rem(139),
...
const StyledMyGridContainerModelRailroaderMagazine = styled(MyGridContainer)(
  ({ theme }) => ({
    // For mobile
    [theme.breakpoints.down("xs")]: {
      paddingBottom: rem(0),
...
const StyledMyGridContainerSouthernPacificDaylight = styled(MyGridContainer)(
  ({ theme }) => ({
    // For mobile
    [theme.breakpoints.down("xs")]: {
      paddingBottom: rem(109),
