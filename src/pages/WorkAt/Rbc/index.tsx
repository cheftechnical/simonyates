						...
						<Sections onChange={handleChange}>
							...
							<Section id="section-1" name="Application Development & Custom&nbsp;Tooling">
								...
								<WorkAtSubSections>
									<WorkAtProject name="SRE Global Dashboard" when="2019–Present">
										...
										<Ul>
											<Li>Interactive series of dashboards for monitoring infrastructure. Know what services are working and how well they're performing.</Li>
											<Li>An organized, real-time view of hundreds of servers across multiple data centers. This was an essential tool during a zero-downtime system upgrade, as it allowed the SRE team to be sure that traffic was routed correctly.</Li>
											<Li>Real-time monitoring of critical infrastructure which the SRE team has an SLA requiring it to provide five-nines availability (99.999%) for the bank.</Li>
										</Ul>
									</WorkAtProject>
									...
									<WorkAtProject next name="Seven Years of Transaction Data" when="2019–Present">
										...
										<Ul>
											<Li>Recommended changes to existing infrastructure that increased reliability of the API</Li>
											<Li>Built a script that reconciled over 21–billion financial transactions to ensure correctness</Li>
											<Li>Designed self-healing tools that would automatically respond to known failure modes</Li>
											<Li>Built tools that automate monthly maintenance activities. Reduced the time that engineers spend each month for maintenance by x%</Li> {/* @todo calculate value */}
											<Li>Built a functional prototype that optimizes Elasticsearch queries to prevent over 4,000 failed search queries each month</Li>
										</Ul>
									</WorkAtProject>

									<WorkAtProject next name="Chatbot" when="2019–Present">
										<Typography group="primary" variant="body" weight="regular">
											The SRE team receives [value] emails every day, many of which are internal customers asking the same general questions, but are specific to their APIs. These customers expected an immediate answer, but the team was not large enough to provide an immediate response.
										</Typography>
										...
										<Callout>
											Python + scikit-learn, NLTK, numpy, pandas &amp; spaCy &bull;
											Elasticsearch
										</Callout>

										<Ul>
											<Li>I built a chatbot from scratch to help the team spend less time answering common questions from internal customers</Li>
											<Li>Uses TF-IDF for token vectorization and the named–entity resolution (NER) from spaCy</Li>
											<Li>Made the chatbot answer questions using real–time data in its response</Li>
										</Ul>
									</WorkAtProject>
									...
									<WorkAtProject next name="OAuth Client Creator for RBC Capital Markets" when="2020–Present">
										...
										<Ul>
											<Li>Streamline creation and approval of OAuth clients, minimizing&nbsp;errors</Li>
											<Li>Added an access control layer to our PingFederate infrastructure</Li>
											<Li>Improved logging and record-keeping of each change for auditors</Li>
										</Ul>
									</WorkAtProject>
								</WorkAtSubSections>
							</Section>
							...
							<Section id="section-2" name="Machine Learning / Artificial&nbsp;Intelligence">
								...
								<Ul>
									...
									<Li>Developed feature-embedded model that optimizes disk space and makes it possible to store years worth of historical logs while preserving entropy. Terabytes of data were reduced to mere gigabytes; without this embedding, we were forced to purge the data after a short period of time.</Li>
								</Ul>
							</Section>
							...
							<Section id="section-3" name="Budgeting">
								...
								<WorkAtSubSections>
									<WorkAtProject name="Cost Chargeback Model" when="2019–Present">
										<Typography group="primary" variant="body" weight="regular">
											In 2020, the SRE team moved to a chargeback costing model. Costs for the services supported by the team were often a mix of direct and shared costs. The pricing model I designed used API request logs to weigh the fixed and variable costs associated each service and provide a total service costs to each business unit. The results from this model were updated in real-time and displayed in the SRE Global Dashboard. In summary, I:
										</Typography>
										...
										<Ul>
											<Li>Developed a charge back model that weighs department costs to internal customers</Li>
											<Li>Costing reports were published in the <em>SRE Global Dashboard</em></Li>
											<Li>Provided a solution that was easily understood and explainable to stakeholders</Li>
										</Ul>
									</WorkAtProject>
								</WorkAtSubSections>
							</Section>
							...
							<Section id="section-4" name="Events">
								...
								<Typography group="primary" variant="body" weight="regular">
									I frequently create presentations about the different projects that I'm working on for our bi-weekly town hall. In 2019, I also hosted an interactive workshop in partnership with Elastic on machine learning for <em>Catalyst</em>, which is an RBC–specific event taking place during the week of Toronto's popular technology event: <em>Collision</em>.
								</Typography>
							...
							<Section id="section-6" name="Active Research">
								...
								<Ul>
									<Li>Optimized feature embedding to reduce terabytes to a few gigs for efficient machine learning</Li>
								</Ul>
							</Section>
							<Section id="section-7" name="Other Activities">
								...
								<Ul>
									...
									<Li>Wrote Groks (Elastic's regular expression language) to parse server logs during data ingestion</Li>
