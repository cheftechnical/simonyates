	...
	return (
		<div>
			...
			<Typography variant="subtitle1" paragraph>
				Thanks for using our products and services (&ldquo;Services&rdquo;). The Services are provided
				by {legalName}, located at:
			</Typography>
			...
			<Typography paragraph>
				{tradeName}&rsquo;s privacy policies explain how we treat your personal data and protect your
				privacy
				when you use our Services. By using our Services, you agree that {tradeName} can use such data in
				accordance with our <Link component={ReactRouterDom} to="/privacy-policy" target="_blank">privacy
				policies</Link>.
			</Typography>
			...
			<Typography paragraph>
				{tradeName} gives you a personal, worldwide, royalty-free, non-assignable and non-exclusive license
				to
				use the software provided to you by {tradeName} as part of the Services. This license is for the
				sole
				purpose of enabling you to use and enjoy the benefit of the Services as provided by {tradeName}, in
				the
				manner permitted by these terms. You may not copy, modify, distribute, sell or lease any part of our
			...
			<Typography paragraph>OTHER THAN AS EXPRESSLY SET OUT IN THESE TERMS OR ADDITIONAL TERMS, NEITHER
				WHIIP NOR ITS SUPPLIERS OR DISTRIBUTORS MAKE ANY SPECIFIC PROMISES ABOUT THE SERVICES. FOR
				EXAMPLE, WE DON’T MAKE ANY COMMITMENTS ABOUT THE CONTENT WITHIN THE SERVICES, THE SPECIFIC FUNCTION
				OF THE SERVICES, OR THEIR RELIABILITY, AVAILABILITY, OR ABILITY TO MEET YOUR NEEDS. WE PROVIDE THE
				SERVICES &ldquo;AS IS&rdquo;.
			</Typography>
			...
			<Typography paragraph>
				WHEN PERMITTED BY LAW, WHIIP, AND WHIIP’S SUPPLIERS AND DISTRIBUTORS, WILL NOT BE RESPONSIBLE
				FOR LOST PROFITS, REVENUES, OR DATA, FINANCIAL LOSSES OR INDIRECT, SPECIAL, CONSEQUENTIAL,
				EXEMPLARY, OR PUNITIVE DAMAGES.
			</Typography>

			<Typography paragraph>
				TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF WHIIP, AND ITS SUPPLIERS AND DISTRIBUTORS,
				FOR ANY CLAIM UNDER THESE TERMS, INCLUDING FOR ANY IMPLIED WARRANTIES, IS LIMITED TO THE AMOUNT YOU
				PAID US TO USE THE SERVICES (OR, IF WE CHOOSE, TO SUPPLYING YOU THE SERVICES AGAIN).
			</Typography>

			<Typography paragraph>
				IN ALL CASES, WHIIP, AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT BE LIABLE FOR ANY LOSS OR
			...
			<Typography>
				For information about how to contact {tradeName}, please visit our <Link component={ReactRouterDom}
																						 to="/contact"
