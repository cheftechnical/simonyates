	...
	return (
		<div>
			...
			<Typography {...paragraph}>OTHER THAN AS EXPRESSLY SET OUT IN THESE TERMS OR ADDITIONAL TERMS, NEITHER
				{tradeName} NOR ITS SUPPLIERS OR DISTRIBUTORS MAKE ANY SPECIFIC PROMISES ABOUT THE SERVICES. FOR
			...
			<Typography {...paragraph}>
				...
				<Link component={ReactRouterDom} to="/contact" target="_blank">contact page</Link>.
			</Typography>
		</div>
	);
};
